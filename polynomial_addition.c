...
struct node * ploynomialAdd(struct node *p1,struct node *p2,struct node *sum){
...
void main(){
    ...
    do
    {
        printf("1. Add to Ploynomial 1\n");
        printf("2. Add to Ploynomial 2\n");
        printf("3. Perform Addtion\n");
        printf("4. Exit\n");
        scanf("\n%d",&ch);
        switch (ch)
        {
